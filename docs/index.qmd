...
Die Bevölkerung in Winterthur - Ein Einblick in die Entwicklung des Ausländeranteils.
...
#### Vorwort zur Problemstellung mit "Viewern"
...
>
>     Nachfolgend werden grosse Tabellen dargestellt, welche vermutlich aufgrund Memory Exhaustion einen Seitenrefresh triggern und dadurch die Generierung des Quarto Dokuments abgebrochen.
>
>     Als alternativer "Viewer" wird mit **`dataframe()`** eine reduzierte aber dafür interaktive Tabelle erstellt.
...
datatable(data_staatenkleingruppe, height = 500)

# Ein flüchtiger Blick ("glimpse") auf die Daten
glimpse(data_staatenkleingruppe)

# Spaltenüberschriften des df
names(data_staatenkleingruppe)

# Einzigartige Werte der Spalten von Interesse - Staatenkleingruppen
unique(data_staatenkleingruppe$staatenkleingruppe)
# Einzigartige Werte der Spalten von Interesse - Stadtkreise
unique(data_staatenkleingruppe$stadtkreis)
# Einzigartige Werte der Spalten von Interesse - Quartiere
unique(data_staatenkleingruppe$quartier)


# Einwohner pro Jahr - Dient u.a. zur Einschätzung der Grössenordnung
...
datatable(data_staatenkleingruppe_false, height = 250)
...
>
> ```         
> Alternativer Code nachfolgend vorhanden aber nicht ausgegeben im Quarto Dokument.
> ```
...
>
> Nachfolgend ist ein Code Chunk mit kable() und gt() aufgrund des Reender Problems ausgeschlossen (siehe [Vorwort zur Problemstellung mit "Viewern"])
...
Betrachtung und Speichern des neu erstellten df

```{r}
datatable(data_staatenkleingruppe_false, height = "500px")
